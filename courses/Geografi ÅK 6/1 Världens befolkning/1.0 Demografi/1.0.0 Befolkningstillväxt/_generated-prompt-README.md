...
Avsnittet du ska skriva är "Befolkningstillväxt", och ligger här i strukturen:
# Jordens förändring
# Världens befolkning
### ----> Befolkningstillväxt
### Befolkningstäthet
...
Jag kommer be dig skriva om underrubrikerna till "Befolkningstillväxt" i en senare fråga.