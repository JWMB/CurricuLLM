...
Avsnittet du ska skriva är "Befolkningstäthet", och ligger här i strukturen:
# Jordens förändring
# Världens befolkning
### Befolkningstillväxt
### ----> Befolkningstäthet
...
Jag kommer be dig skriva om underrubrikerna till "Befolkningstäthet" i en senare fråga.